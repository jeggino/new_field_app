...
# --------------------------------------------------
    ...
    if upload_response.status_code in [200, 201]:
        ...
        st.markdown(f"De kaart is met succes naar de GitHub‑repository geüpload. Klik op deze [link]({github_url}) om de kaart te bekijken en te delen als je dat wilt.")
